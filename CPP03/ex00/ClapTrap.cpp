...
ClapTrap::ClapTrap() : _name("Groot"), _hitpoins(10), _energy_points(10), _attack_damage(0)
{
    std::cout << "Character " << color(4) << "Groot" << color(0) << " created" << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hitpoins(10), _energy_points(10), _attack_damage(0)
{
    std::cout << "Character " << color(4) << name << color(0) << " created" << std::endl;
}
...
{
    std::cout << "New character stole " << color(4) << a._name << "'s" << color(0) <<
    " character's brain" << std::endl;
}

ClapTrap::~ClapTrap()
{
    std::cout << "ClapTrap " << color(4) << this->_name << color(0) << " is dead" << std::endl;
}
...
{
    if (amount > INT_MAX)
        std::cout << color(1) << "Invalid number. Use from 0 to INT_MAX" << color(0) << std::endl;
    else
    {
...
{
    std::cout << "The character " << color(4) << this->_name << color(0) <<
