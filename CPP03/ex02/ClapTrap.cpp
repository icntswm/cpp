...
ClapTrap::ClapTrap() : _name("Groot"), _hitpoins(100), _energy_points(100), _attack_damage(30)
{
    std::cout << "ClapTrap constructor called" << std::endl;
}

ClapTrap::ClapTrap(std::string name) : _name(name), _hitpoins(100), _energy_points(100), _attack_damage(30)
{
    std::cout << "ClapTrap constructor called" << std::endl;
}
